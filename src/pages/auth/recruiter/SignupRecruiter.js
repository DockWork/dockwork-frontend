...
const SignupRecruiter = ({register, registerLoading}) => {
    ...
    <Row justify="center">
      <Col xl={{span: 8}} md={{span: 12}} xs={{span: 22}}>
        ...
        <div className="auth-link-holder">
          Already have an account? <Link to="/rc/login">Log in!</Link>
        </div>
      </Col>
    </Row>
  )
...
export default connect(mapStateToProps, mapDispatchToProps)(SignupRecruiter)
