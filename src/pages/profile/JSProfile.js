...
export const JSProfile = ({
  ...
  const handleChangePass = (values) => {
    changeJobSeekerPassword({oldPassword: values.oldPassword, newPassword: values.newPassword}, setIsModalVisible)
  }

  const handleEdit = (values) => {
    editJobSeekerProfile(values)
  }
...
const mapStateToProps = (state) => ({
  ...
  changePasswordLoading: state.jobSeeker.changePasswordLoading,
  editProfileLoading: state.jobSeeker.editProfileLoading,
})
const mapDispatchToProps = (dispatch) => ({
  changeJobSeekerPassword: (data, state) => dispatch(jobSeekerActions.changeJobSeekerPassword(data, state)),
  editJobSeekerProfile: (data) => dispatch(jobSeekerActions.editJobSeekerProfile(data)),
})

export default connect(mapStateToProps, mapDispatchToProps)(JSProfile)
